...
@AclResc(id= 200,code = "aclRescRole", name = AclRescRoleController.MODULE_NAME,homePage = AclRescRoleController.HOME_PAGE,target = AclResource.Target.ACLUSER,isMenu = false)
public class AclRescRoleController extends BaseController {
    ...
    @AclResc(id= 201,code = "list",name = "角色资源列表")
    ...
    @AclResc(id= 202,code = "add",name = "新增角色资源")
    ...
    @AclResc(id = 203,code = "update",name = "更新角色资源")
    ...
    @AclResc(id = 204,code = "delete",name = "删除角色资源")
    ...
    @AclResc(id = 205,code = "addByRescIdRoleId",name = "根据资源角色新增")
    ...
    @AclResc(id = 206,code = "deleteByRescIdRoleId",name = "根据资源角色删除")
