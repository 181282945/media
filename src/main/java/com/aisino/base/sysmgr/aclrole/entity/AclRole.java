...
public class AclRole extends BaseEntity {
    ...
    public enum Target {
        ...
        public static Parameter[] getParams(){
            Parameter[] targetParams = new Parameter[AclRole.Target.values().length];

            for(int i=0;i<targetParams.length;i++){
                targetParams[i] = new Parameter(AclRole.Target.values()[i].getCode(), AclRole.Target.values()[i].getName());
            }
            return  targetParams;
        }
    ...
    public enum DefType {
        ...
        public static Parameter[] getParams(){
            Parameter[] defTypeParams = new Parameter[AclRole.DefType.values().length];

            for(int i=0;i<defTypeParams.length;i++){
                defTypeParams[i] = new Parameter(AclRole.DefType.values()[i].getCode().toString(), AclRole.DefType.values()[i].getName());
            }
