package com.lzw.base.sysmgr.aclmenu.service.impl;

import com.lzw.base.sysmgr.aclmenu.dao.AclMenuMapper;
...
import com.lzw.core.security.MySecurityMetadataSource;
import com.lzw.core.security.util.SecurityUtil;
import com.lzw.base.sysmgr.aclmenu.domain.entity.AclMenu;
import com.lzw.base.sysmgr.aclmenu.service.AclMenuService;
...
public class AclMenuServiceImpl extends BaseServiceImpl<AclMenu, AclMenuMapper> implements AclMenuService {
    ...
    private Map<AclMenu, List<AclResource>> findAclMenuModuleMap() {
        ...
        List<AclResource> moduleTargetAList = aclResourceService.findModule();
