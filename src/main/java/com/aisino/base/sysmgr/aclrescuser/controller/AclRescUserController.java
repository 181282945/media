...
@AclResc(id = 500,code = "aclRescUser", name = AclRescUserController.MODULE_NAME,homePage = AclRescUserController.HOME_PAGE,target = AclResource.Target.ACLUSER,isMenu = false)
public class AclRescUserController extends BaseController {
    ...
    @AclResc(id = 501,code = "list",name = "用户资源列表")
    ...
    @AclResc(id = 502,code = "add",name = "新增用户资源")
    ...
    @AclResc(id = 503,code = "update",name = "更新用户资源")
    ...
    @AclResc(id = 504,code = "delete",name = "删除用户资源")
    ...
    @AclResc(id = 505,code = "addByRescIdUserId",name = "根据资源角色新增")
    ...
    @AclResc(id = 506,code = "deleteByRescIdUserId",name = "根据资源用户删除")
