...
@AclResc(id = 7000,code = "aclroleauth", name = AclRoleAuthController.MODULE_NAME,homePage = AclRoleAuthController.HOME_PAGE,target = AclResource.Target.ACLUSER,isMenu = false)
