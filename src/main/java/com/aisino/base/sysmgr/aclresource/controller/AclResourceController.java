...
@AclResc(id= 100,code = "aclResource", name = AclResourceController.MODULE_NAME,homePage = AclResourceController.HOME_PAGE,target = AclResource.Target.ACLUSER)
public class AclResourceController extends BaseController {
    ...
    public ModelAndView toList(){
        ...
        mav.addObject("aclResrouceTypeParams",ParamUtil.JqgridSelectVal(ParamUtil.FirstOption.QUERY,AclResource.Type.getParams()));
        mav.addObject("aclResrouceTargetParams",ParamUtil.JqgridSelectVal(ParamUtil.FirstOption.QUERY,AclResource.Target.getParams()));
        mav.addObject("aclMenuParams",ParamUtil.JqgridSelectVal(ParamUtil.FirstOption.QUERY,Params.getAclMenuParams()));
        return mav;
    }
    ...
    @AclResc(id= 101,code = "listModule",name = "查询列表")
    ...
    @AclResc(id= 102,code = "listModuleAuthByAclUserId",name = "后台用户模块权限查询")
    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    ...
    @AclResc(id= 103,code = "listModuleAuthByUserId",name = "后台用户模块权限查询")
    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    ...
    @AclResc(id= 104,code = "listModuleAuthByRoleId",name = "角色模块权限查询")
    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    ...
    @AclResc(id= 105,code = "listMethod",name = "方法列表")
    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    ...
    @AclResc(id= 106,code = "listMethodAuth",name = "精确权限")
    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    ...
    @AclResc(id= 107,code = "listMethodAuthByRoleId",name = "角色方法权限查询")
    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    ...
    @AclResc(id= 108,code = "listMethodAuthByUserId",name = "用户方法权限查询")
    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    ...
    @AclResc(id= 109,code = "add",name = "新增资源")
    ...
    @AclResc(id= 110,code = "view",name = "明细")
    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    ...
    @AclResc(id= 111,code = "update",name = "更新资源")
