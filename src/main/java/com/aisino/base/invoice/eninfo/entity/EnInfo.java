...
public class EnInfo extends BaseInvoiceEntity {
     ...
     * 二维码开票项目数量
     */
    private String qrcodeItemNum;

    /**
     * 二维码开票税控分类编码
     */
    private String qrcodeTaxClassCode;
    ...
    public String getQrcodeTaxRate() {
        return qrcodeTaxRate;
    }

    public void setQrcodeTaxRate(String qrcodeTaxRate) {
        this.qrcodeTaxRate = qrcodeTaxRate;
    }
    ...
    public String getQrcodeItemNum() {
        return qrcodeItemNum;
    }

    public void setQrcodeItemNum(String qrcodeItemNum) {
        this.qrcodeItemNum = qrcodeItemNum;
    }
    ...
    public String getQrcodeTaxClassCode() {
        return qrcodeTaxClassCode;
    }

    public void setQrcodeTaxClassCode(String qrcodeTaxClassCode) {
        this.qrcodeTaxClassCode = qrcodeTaxClassCode;
    }
...
//---------------------------------------------------------枚举--------------
    ...
    public enum YhzcbsType {
        ...
        public static Parameter[] getParams(){
            Parameter[] yhzcbsTypeParams = new Parameter[YhzcbsType.values().length];

            for(int i=0;i<yhzcbsTypeParams.length;i++){
                yhzcbsTypeParams[i] = new Parameter(YhzcbsType.values()[i].getCode().toString(),YhzcbsType.values()[i].getName());
            }
    ...
    public enum LslbsType {
        ...
        public static Parameter[] getParams(){
            Parameter[] lslbsTypeParams = new Parameter[LslbsType.values().length];

            for(int i=0;i<lslbsTypeParams.length;i++){
                if(LslbsType.values()[i].getCode() == null)
                lslbsTypeParams[i] = new Parameter("",LslbsType.values()[i].getName());
                else
                    lslbsTypeParams[i] = new Parameter(LslbsType.values()[i].getCode().toString(),LslbsType.values()[i].getName());
            }
