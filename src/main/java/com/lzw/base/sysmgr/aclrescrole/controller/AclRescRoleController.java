package com.lzw.base.sysmgr.aclrescrole.controller;
...
@AclResc(id= 2000,code = "aclRescRole", name = AclRescRoleController.MODULE_NAME,homePage = AclRescRoleController.HOME_PAGE,isMenu = false)
