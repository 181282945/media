package com.lzw.base.sysmgr.aclroleauth.controller;
...
@AclResc(id = 7000,code = "aclroleauth", name = AclRoleAuthController.MODULE_NAME,homePage = AclRoleAuthController.HOME_PAGE)
