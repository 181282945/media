...
@AclResc(id = 400, code = "aclAuth", name = AclAuthController.MODULE_NAME, homePage = AclAuthController.HOME_PAGE, target = AclResource.Target.ACLUSER, isMenu = false)
public class AclAuthController extends BaseController {
    ...
    @AclResc(id = 401, code = "list", name = "权限列表")
    ...
    @AclResc(id = 402, code = "add", name = "新增权限")
    ...
    @AclResc(id = 403, code = "update", name = "更新权限")
    ...
    @AclResc(id = 404, code = "delete", name = "删除权限")
    ...
    @AclResc(id = 405, code = "addByRescId", name = "新增方法权限控制")
    ...
    @AclResc(id = 406, code = "deleteByRescId", name = "删除方法权限控制")
    @Transactional(propagation = Propagation.REQUIRES_NEW)
