...
@AclResc(id = 600, code = "aclRole", name = AclRoleController.MODULE_NAME, homePage = AclRoleController.HOME_PAGE, target = AclResource.Target.ACLUSER)
public class AclRoleController extends BaseController {
    ...
    public ModelAndView toList() {
        ...
        mav.addObject("aclRoleTargetParams", ParamUtil.JqgridSelectVal(ParamUtil.FirstOption.QUERY,AclRole.Target.getParams()));
        mav.addObject("aclRoleDefTypeParams", ParamUtil.JqgridSelectVal(ParamUtil.FirstOption.QUERY,AclRole.DefType.getParams()));
        return mav;
    }
    ...
    @AclResc(id = 601, code = "list", name = "查询列表")
    ...
    @AclResc(id = 603, code = "add", name = "查询列表")
    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    ...
    @AclResc(id = 604, code = "update", name = "修改角色")
    ...
    @AclResc(id = 602, code = "delete", name = "删除角色")
