...
@AclResc(id = 300,code = "aclmenu", name = AclMenuController.MODULE_NAME,homePage = AclMenuController.HOME_PAGE,target = AclResource.Target.ACLUSER)
public class AclMenuController extends BaseController {
    ...
    @AclResc(id = 301,code = "list",name = "菜单列表")
    ...
    @AclResc(id = 302,code = "add",name = "新增菜单")
    ...
    @AclResc(id = 303,code = "update",name = "更新菜单")
    ...
    @AclResc(id = 304,code = "delete",name = "删除菜单")
    ...
    @AclResc(id = 305,code = "getAclUserMenus",name = "获取菜单")
    @Transactional(readOnly = true)
